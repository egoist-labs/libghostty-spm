...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/egoist-labs/libghostty-spm/releases/download/storage.1.3.6/GhosttyKit.xcframework.zip",
            checksum: "f60e46d2829e892c23cc6ee6e1eb0dccddcb0ba77727c830b69a6b0d1d9a9821"
        ),
        .testTarget(
            name: "GhosttyKitTest",
