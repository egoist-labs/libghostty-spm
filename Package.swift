...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/egoist-labs/libghostty-spm/releases/download/storage.1.3.5/GhosttyKit.xcframework.zip",
            checksum: "75ee2783373dbfd285d2a7efc316060173e1e6f1b9d7938cb671ccf46b34e143"
        ),
        .testTarget(
            name: "GhosttyKitTest",
